...
import logger_config, utils, sites
...
class InstanceManager:
    def __init__(
        ...
        self.proxies = ProxyGetter(os.path.join(os.getcwd(), "settings", proxy_file_name))
    ...
    def get_ad_counter(self) -> bool:
        return bool(self.ad_counter)

    def set_ad_counter(self, new_value: bool):
        print("Ad Counter set to " + str(new_value))
        self.ad_counter = new_value

    def get_ad_count(self) -> int:
        return int(self.ad_count)

    def set_ad_count(self, new_value: int):
        print("Ad Count set to " + str(new_value))
        self.ad_count = new_value

    def get_ad_max(self) -> int:
        return int(self.ad_max)

    def set_ad_max(self, new_value: int):
        print("Ad Max set to " + str(new_value))
        self.ad_max = new_value
